...
# Generated by qmake (2.01a) (Qt 4.6.3) on: ter jun 15 10:18:12 2010
...
INCPATH       = -I/usr/share/qt/mkspecs/linux-g++-64 -Inbproject -I/usr/include/QtCore -I/usr/include/QtGui -I/usr/include -I. -Inbproject -I.
LINK          = g++
...
SOURCES       = qextserialport_mod/posix_qextserialport.cpp \
		qextserialport_mod/qextserialbase.cpp \
		qextserialport_mod/qextserialport.cpp \
		RS232_Conection.cpp \
		main.cpp 
OBJECTS       = build/Debug/GNU-Linux-x86/posix_qextserialport.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/miniPBX1.0.0/ && $(COPY_FILE) --parents RS232_Conection.h qextserialport_mod/qextserialport.h qextserialport_mod/qextserialbase.h qextserialport_mod/posix_qextserialport.h nbproject/build/Debug/GNU-Linux-x86/miniPBX1.0.0/ && $(COPY_FILE) --parents qextserialport_mod/posix_qextserialport.cpp qextserialport_mod/qextserialbase.cpp qextserialport_mod/qextserialport.cpp RS232_Conection.cpp main.cpp nbproject/build/Debug/GNU-Linux-x86/miniPBX1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/miniPBX1.0.0` && $(TAR) miniPBX1.0.0.tar miniPBX1.0.0 && $(COMPRESS) miniPBX1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/miniPBX1.0.0`/miniPBX1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/miniPBX1.0.0
