#############################################################################
# Makefile for building: dist/Debug/GNU-Linux-x86/Desktop
# Generated by qmake (2.01a) (Qt 4.6.2) on: qui mai 20 21:02:29 2010
...
INCPATH       = -I/usr/share/qt/mkspecs/linux-g++-64 -Inbproject -I/usr/include/QtCore -I/usr/include/QtGui -I/usr/include/QtSql -I/usr/include -I. -Inbproject -I.
LINK          = g++
...
TARGET        = dist/Debug/GNU-Linux-x86/Desktop
...
dist: 
	@$(CHK_DIR_EXISTS) nbproject/build/Debug/GNU-Linux-x86/Desktop1.0.0 || $(MKDIR) nbproject/build/Debug/GNU-Linux-x86/Desktop1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/Desktop1.0.0/ && $(COPY_FILE) --parents MysqlConection.h qextserialport_mod/posix_qextserialport.h qextserialport_mod/qextserialbase.h qextserialport_mod/qextserialport.h RS232_Conection.h nbproject/build/Debug/GNU-Linux-x86/Desktop1.0.0/ && $(COPY_FILE) --parents MysqlConection.cpp RS232_Conection.cpp qextserialport_mod/qextserialbase.cpp qextserialport_mod/posix_qextserialport.cpp main.cpp qextserialport_mod/qextserialport.cpp nbproject/build/Debug/GNU-Linux-x86/Desktop1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/Desktop1.0.0` && $(TAR) Desktop1.0.0.tar Desktop1.0.0 && $(COMPRESS) Desktop1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/Desktop1.0.0`/Desktop1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/Desktop1.0.0
...
build/Debug/GNU-Linux-x86/MysqlConection.o: MysqlConection.cpp MysqlConection.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/MysqlConection.o MysqlConection.cpp
